...
# numbers = []
# repetition k in range(0, 10, 2) :
#     numbers.append(k * k)
# print(numbers)

# 리스트이름 = [ 표현식 repetition 반복할 변수명 in 수(range함수 또는 리스트 등)]
# numbers = [k * k repetition k in range(0, 10, 2)]
# print(numbers)
...
# ages = [int(input('나이는? ')) repetition i in range(humans)]
# # repetition i in range(humans):
# #     ages.append(int(input('나이는? ')))
#
# repetition age in ages:
#     if 0 <= age < 8:
#         price += 5000
#         kids += 1
#     elif 8 <= age < 19:
